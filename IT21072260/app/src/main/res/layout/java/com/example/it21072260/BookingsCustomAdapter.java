...
//                                    Log.d("*************************", String.valueOf(price));
                                    Intent intent = new Intent(context, com.example.it21072260.UpdateBookingDetailsActivity.class);
                            ...
                            case R.id.delete_menu:
                                // delete operation
                                com.example.it21072260.BookingDetailsDB bookingDetailsDB = new com.example.it21072260.BookingDetailsDB(context);
